...
// configuration step. It creates a namespace called `xstl`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", xstl::cmake::project_name, xstl::cmake::project_version) };
